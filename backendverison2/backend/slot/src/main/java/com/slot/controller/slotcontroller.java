...
//	http://localhost:8087/slot/v1/getSlotByavailability
	...
	public ResponseEntity<?> getSlotByIdHandler(@PathVariable int slotid) throws slotNotFoundException 
	{
	...
	public ResponseEntity<?> updateNoteHandler(@RequestBody slot sobj,@PathVariable int slotid) throws slotNotFoundException 
	{
	...
	@PostMapping("/addSlot")
	public ResponseEntity<?> sendSlotHandler(@RequestBody slot sobj) throws slotAlreadyExistsException
	{
		slot newSlot=null;
//		try {
